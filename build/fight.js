...
function fight() {
    ...
    function userDamage(damage) {
        if (Number(computerPokemonProgressBar.value) >= damage) {
            ...
            return cpu.currentPokemon[0].health = Number(computerPokemonProgressBar.value) - cpu.currentPokemon[0].health;
        }
    }
    ...
    function cpuDamage(damage) {
        if (Number(userPokemonProgressBar.value) >= damage) {
            ...
            return user.currentPokemon[0].health = Number(userPokemonProgressBar.value) - user.currentPokemon[0].health;
        }
    }
